...
// ==========================================
// 1. DATA DEFINITIONS & NEW ZEALAND CONTENT
// ==========================================

const newZealandHeroSlides = [
  {
    id: 0,
    eyebrow: "KIWI TECHNOLOGY & SOFTWARE ENGINEERING PARTNER",
    flag: "🇳🇿",
    title: "Engineering Scalable Web, Mobile & Cloud Systems for Kiwi Innovators",
    desc: "From Auckland tech headquarters to Wellington GovTech agencies and Christchurch AgriTech hubs, Mitsafe builds robust, compliant software that streamlines operations, modernizes legacy workflows, and scales New Zealand business performance.",
    primaryBtnText: "Book a Free NZ Discovery Call",
    primaryBtnHref: "/contact",
    secondaryBtnText: "Explore Kiwi Solutions",
    secondaryBtnHref: "#services",
    image: "/images/australia_hero_bg.jpg",
    badges: ["Auckland • Wellington • Christchurch", "Windcave & NZ GST 15% Ready", "100% NZ Privacy Act & Code Ownership"],
  },
  {
    id: 1,
    eyebrow: "AGRITECH, SAAS & ENTERPRISE CLOUD",
    flag: "🇳🇿",
    title: "High-Scale Microservices, Cloud DevOps & AgriTech Supply Chains",
    desc: "Connect finance, cold-chain logistics, multi-branch depots, client portals, and automated NZ GST (15%) reporting with resilient AWS Australasia cloud architecture.",
    primaryBtnText: "Consult Our Engineers",
    primaryBtnHref: "/contact",
    secondaryBtnText: "View NZ Architecture",
    secondaryBtnHref: "#services",
    image: "/images/australia_about_workspace.jpg",
    badges: ["99.99% Uptime SLA", "Australasia Cloud Hosting", "Automated GST 15% Engine"],
  },
  {
    id: 2,
    ...
    desc: "Turn complex business operations into intuitive customer apps, staff portals, secure fintech pipelines, and automated AI data workflows designed for high-velocity New Zealand growth.",
    primaryBtnText: "Get an Instant Scope",
    primaryBtnHref: "/contact",
    secondaryBtnText: "Explore Tech Stack",
    secondaryBtnHref: "#services",
    image: "/portfolio_hero.webp",
    badges: ["iOS & Android Multiplatform", "Next.js 15 & React 19", "Dedicated NZST Sprint Squads"],
  },
];

const newZealandQuickStats = [
  { label: "NZ Systems Delivered", value: "140+", icon: Boxes },
  { label: "Code & IP Ownership", value: "100%", icon: ShieldCheck },
  { label: "Australasia Cloud SLA", value: "99.99%", icon: Cloud },
  { label: "NZ Privacy Act 2020", value: "Compliant", icon: Shield },
  { label: "NZST / NZDT Timezone", value: "Direct Support", icon: Clock },
];

const newZealandServicePillars = [
  {
    id: "agri-erp",
    num: "01",
    badge: "AgriTech & Operations",
    title: "Bespoke Kiwi ERP, AgriTech & Logistics Software",
    headline: "Centralize Multi-Depot Operations & Farm-to-Export Traceability",
    desc: "Connect your enterprise into one synchronized digital operating platform. Seamlessly integrate automated dairy and horticulture batch records, MPI export documentation, bonded warehouse tracking, and multi-depot inventory.",
    image: "/showcase/web_1.webp",
    imageAlt: "New Zealand Enterprise ERP and AgriTech Logistics Management Dashboard",
    techStack: ["Next.js 15", "PostgreSQL", "AWS Sydney / Auckland", "GraphQL", "TypeScript"],
    liveStat: "⚡ Real-Time Farm-to-Port Sync Active",
    services: [
      { title: "Bespoke Business ERP", desc: "Software engineered around your exact Kiwi commercial processes and workflows." },
      { title: "AgriTech & Cold Chain WMS", desc: "Warehouse bin tracking, MPI certification logs, and automated courier API routing." },
      { title: "Multi-Store Retail & POS", desc: "Modern point-of-sale with live stock synchronization across North & South Islands." },
    ],
  },
  {
    id: "fintech-windcave",
    ...
    title: "Windcave, KiwiPay, Afterpay & NZ GST 15% Engine",
    headline: "Automate NZ Payments, Direct Banking & IRD Tax Filings",
    desc: "Build engaging customer platforms, seamless mobile commerce experiences, and automated sales pipelines with New Zealand payment gateways (Windcave, Stripe, Afterpay, Apple Pay, and automated direct banking in NZD).",
    image: "/showcase/web_3.webp",
    imageAlt: "New Zealand Mobile Application and E-Commerce Payment Platform",
    techStack: ["React Native", "Flutter", "Windcave APIs", "Stripe NZ", "TypeScript"],
    liveStat: "🚀 3.4x Faster Kiwi Checkout Speeds",
    services: [
      { title: "Automated NZ GST 15%", desc: "Real-time calculation of standard 15% GST and IRD-compatible reporting logs." },
      { title: "Windcave & Direct Banking", desc: "Frictionless checkout flows with instant bank authorization and direct debits." },
      { title: "B2B Client Portals", desc: "Automated retainer billing, recurring invoices, and secure digital payment links." },
    ],
  },
  {
    id: "ai-cloud-nz",
    ...
    title: "AI Automation, NZ Cloud & Cybersecurity Architecture",
    headline: "Automate Back-Office Workflows on Secure Australasian Cloud",
    desc: "Scale your back-office with AI agents, document parsing OCR, and resilient AWS Australasia cloud architecture designed for strict New Zealand Privacy Act 2020 and enterprise security compliance.",
    image: "/showcase/web_2.webp",
    imageAlt: "New Zealand Cloud Infrastructure and AI Automation Architecture",
    techStack: ["OpenAI LLM", "Python FastAPI", "AWS ap-southeast-2", "Docker", "NZ Privacy 2020"],
    liveStat: "🤖 89% Automated Invoice & Freight Processing",
    services: [
      { title: "AI Workflow Automation", desc: "Automate invoice reconciliation, data extraction, and repetitive manual tasks." },
      { title: "Managed Cloud & Hosting", desc: "Hosted in secure Australasian datacentres with automated daily backups and 99.99% uptime." },
      { title: "Zero-Trust Cybersecurity", desc: "Role-based access controls (RBAC), end-to-end encryption, and audit logs." },
    ],
  },
];

const newZealandIndustries = [
  {
    id: "agritech",
    title: "Dairy & AgriTech",
    icon: Factory,
    desc: "Milk vat telemetry, pasture management data, MPI compliance logging, and farm-to-shelf traceability.",
    badge: "Waikato & Canterbury",
    stat: "100% Cold Chain QA",
  ...
  },
  {
    ...
    icon: DollarSign,
    desc: "Windcave payment gateways, automated NZD reconciliation, KYC onboarding, and real-time financial reporting.",
    badge: "Auckland Commercial Hub",
    stat: "FMA & Open Banking Ready",
    img: "/images/industry/fintech_banking_hero.png",
  },
  {
    id: "horticulture",
    title: "Horticulture & Viticulture",
    icon: Mountain,
    desc: "Vineyard block tracking, harvest yields, export phytosanitary documentation & seasonal labor timesheets.",
    badge: "Marlborough & Hawke's Bay",
    stat: "Export Phytosanitary Sync",
  ...
  },
  {
    ...
    icon: Rocket,
    desc: "Telemetry data ingestion, satellite ground station APIs, and real-time aerospace mission control analytics.",
    badge: "Mahia & Christchurch",
    stat: "Sub-Second Telemetry Ingest",
    img: "/solutions_engineering.webp",
  },
  {
    id: "tourism",
    title: "Tourism & Alpine Hospitality",
    icon: Compass,
    desc: "Omnichannel booking engines, ski-pass NFC integrations, dynamic multi-currency pricing, and VIP loyalty.",
    badge: "Queenstown & Rotorua",
    stat: "+32% Direct Bookings",
  ...
  },
  {
    ...
    icon: Stethoscope,
    desc: "Patient booking platforms, electronic health records (EHR), clinic billing, and automated patient alerts.",
    badge: "Auckland & Dunedin",
    stat: "Health Information Privacy",
  ...
  },
  {
    ...
    icon: Truck,
    desc: "Warehouse bin tracking, customs documentation, NZ Post courier sync & multi-currency supplier billing.",
    badge: "Tauranga Port & Auckland",
    stat: "Real-Time GPS Fleet Sync",
    img: "/showcase/hosting_1.webp",
  },
  {
    id: "cleantech",
    title: "Geothermal & CleanTech",
    icon: Zap,
    desc: "Geothermal grid telemetry, smart hydro-electric monitoring, carbon credit accounting & ESG reporting.",
    badge: "Taupo & Manawatu",
    stat: "99.999% Grid Telemetry Uptime",
    img: "/engineering_culture.webp",
  },
  {
    id: "govtech",
    title: "GovTech & Civic Services",
    icon: Building2,
    desc: "Citizen grant management portals, strict zero-trust access control, public sector auditing & voter systems.",
    badge: "Wellington Capital Hub",
    stat: "NZ Cloud First Compliant",
    img: "/images/australia_about_workspace.jpg",
  },
  {
    id: "startups",
    title: "Kiwi SaaS & Tech Scaleups",
    icon: Laptop,
    desc: "Rapid MVP engineering, scalable cloud backends, automated user onboarding & lightweight administration.",
    badge: "Silicon Welly & AKL Tech",
...
const newZealandCities = [
  { name: "Auckland", hub: "Wynyard Quarter Tech Precinct • Britomart • Queen Street Hub", badge: "Commercial & FinTech Hub", projects: "140+ Systems Deployed" },
  { name: "Wellington", hub: "Silicon Welly • Lambton Quay • Te Aro Digital Quarter", badge: "GovTech & Creative Capital", projects: "45+ Enterprise Portals" },
  { name: "Christchurch", hub: "Innovation Precinct • High Street • AgriTech Hub", badge: "AgriTech & Aerospace", projects: "35+ Systems" },
  { name: "Hamilton & Tauranga", hub: "Waikato Innovation Park • Port of Tauranga Corridor", badge: "Agriscience & Freight", projects: "28+ Logistics Apps" },
  { name: "Queenstown", hub: "Queenstown Central • Alpine Innovation Hub", badge: "Tourism & Hospitality", projects: "20+ Web & Apps" },
  { name: "Dunedin", hub: "Dunedin Tech Precinct • University Innovation Zone", badge: "MedTech & EdTech", projects: "15+ Cloud Platforms" },
];

const newZealandFaqs = [
  {
    q: "How does Mitsafe ensure compliance with the New Zealand Privacy Act 2020?",
    a: "All software architectures developed by Mitsafe adhere strictly to the New Zealand Privacy Act 2020 and the Information Privacy Principles (IPPs). We implement robust role-based access controls (RBAC), end-to-end data encryption, and deploy systems in secure Australasian cloud data centers.",
  },
  {
    q: "Do we get full source code, intellectual property, and database ownership?",
    a: "Yes! Under our Bespoke Custom Software Development model, your New Zealand organization receives 100% intellectual property, full GitHub repository access, and complete database ownership with zero recurring vendor royalties.",
  },
  {
    q: "Can you integrate New Zealand payment gateways like Windcave?",
    a: "Yes! We regularly integrate popular New Zealand payment methods including Windcave, Stripe, Afterpay, Apple Pay, and automated direct banking workflows in NZD with full NZ GST (15%) calculation and reporting.",
  },
  {
    q: "How do your developers collaborate with New Zealand working hours?",
    a: "We offer dedicated overlapping working hours during New Zealand Standard Time (NZST) and New Zealand Daylight Time (NZDT). Daily morning standups and real-time Slack/Teams channels ensure seamless communication.",
  },
];

export default function NewZealandLandingClient() {
  ...
  const totalSlides = newZealandHeroSlides.length;
  ...
  useEffect(() => {
    const pillarInterval = setInterval(() => {
      setActivePillarIndex((prev) => (prev + 1) % newZealandServicePillars.length);
    }, 5000);
  ...
  const slide = newZealandHeroSlides[currentSlide] || newZealandHeroSlides[0];

  return (
    <div className="min-h-screen bg-white text-slate-900 overflow-x-hidden font-sans selection:bg-[#305EFF] selection:text-white">

      {/* =========================================================================
          1. HERO SECTION (Exact 3D Motion Carousel + Cascading Words for New Zealand)
          ========================================================================= */}
      <section
      ...
      >
        ...
        <div className="absolute bottom-6 left-1/2 -translate-x-1/2 z-20 flex items-center gap-2.5 bg-black/40 backdrop-blur-md px-4 py-2 rounded-full border border-white/15">
          {newZealandHeroSlides.map((_, idx) => (
            <button
              key={idx}
      ...
      {/* =========================================================================
          FLOATING NEW ZEALAND METRIC ISLAND (Light High-Precision Quick Stats Ribbon)
          ========================================================================= */}
      <div className="relative z-20 -mt-8 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white/95 backdrop-blur-xl rounded-2xl p-4 sm:p-5 border border-slate-200/90 shadow-2xl grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4 divide-y sm:divide-y-0 sm:divide-x divide-slate-100 items-center">
          {newZealandQuickStats.map((stat, sIdx) => {
      ...
      {/* =========================================================================
          2. NEW ZEALAND BUSINESS & CLOUD ARCHITECTURE (3D Canvas + Editorial Reveal)
          ========================================================================= */}
      <section className="py-24 lg:py-28 bg-white border-b border-slate-100 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-14 items-center">
            ...
            {/* Left Column: 3D Interactive Kiwi Architecture Canvas */}
            <motion.div
                ...
                <div className="relative rounded-3xl overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.18)] border-2 border-slate-800 bg-slate-950 group">
                  ...
                  <div className="h-8 bg-slate-900 border-b border-slate-800 px-4 flex items-center justify-between">
                    ...
                    <span className="text-[10px] font-mono text-slate-400">
                      nz-cloud-topology // auckland-ap-southeast-2
                    </span>
                  ...
                  <div className="relative h-[340px] sm:h-[380px] w-full bg-slate-950">
                    <Image
                      src="/images/australia_about_workspace.jpg"
                      alt="Mitsafe New Zealand Software Architecture and Cloud Topology over Auckland Wynyard Quarter"
                      fill
                    ...
                    <Floating3DObject duration={4.2} yOffset={-8} rotateRange={-2} className="absolute top-4 left-4 z-20">
                      <div className="bg-slate-950/95 backdrop-blur-md px-3.5 py-1.5 rounded-full border border-emerald-500/40 text-emerald-400 text-xs font-black shadow-2xl flex items-center gap-2">
                        ...
                        <span>100% NZ Privacy Act 2020</span>
                      </div>
                    </Floating3DObject>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <div className="text-xs font-black text-white uppercase tracking-wider">
                            Dedicated Kiwi Engineering Squads
                          </div>
                          <div className="text-[11px] text-slate-300">
                            Zero vendor lock-in • Complete NZ IP transfer
                          </div>
                        </div>
                      </div>
            ...
            <div className="lg:col-span-6 space-y-6 text-left">
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-blue-50 text-[#305EFF] text-xs font-extrabold uppercase tracking-wider border border-blue-200">
                ...
                <span>SOVEREIGN DIGITAL SOLUTIONS FOR NEW ZEALAND</span>
              </div>

              <h2 className="text-2xl sm:text-4xl lg:text-[2.6rem] font-black text-slate-900 tracking-tight leading-[1.15]">
                <ScrollHeading3D text="Software Engineered for How Kiwi Enterprises Scale & Compete" direction="left" />
              </h2>

              <p className="text-slate-600 text-sm sm:text-base leading-relaxed">
                New Zealand businesses operate in dynamic export, AgriTech, and digital markets. Mitsafe replaces fragmented spreadsheets, expensive legacy ERP retainers, and siloed tools with custom-built enterprise platforms, automated Windcave workflows, and secure cloud pipelines.
              </p>
                ...
                {[
                  {
                    icon: ShieldCheck,
                    badge: "NZ Privacy",
                    title: "NZ Privacy Act 2020 & Governance",
                    desc: "Engineered to strict New Zealand Information Privacy Principles with granular access control and local cloud data vaults.",
                  },
                  {
                    icon: Layers,
                    badge: "AgriTech Sync",
                    title: "Cold Chain & Supply Chain WMS",
                    desc: "Synchronize dairy, horticulture, and freight documentation across North and South Island depots with sub-second latency.",
                  },
                  {
                    icon: Headphones,
                    badge: "Direct Support",
                    title: "Direct NZST Engineering Collaboration",
                    desc: "Work directly with lead architects and senior software engineers during Kiwi business hours with transparent sprint reviews.",
                  },
                ].map((item, idx) => {
              ...
              <div className="pt-3">
                ...
                >
                  <span>Discuss Your Kiwi Project</span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-3">
            <div className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-blue-100 text-[#305EFF] text-xs font-extrabold uppercase tracking-wider border border-blue-200">
              ...
              <span>Full-Cycle Kiwi Software Engineering</span>
            </div>
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-slate-900 tracking-tight leading-tight">
              <ScrollHeading3D text="Mission-Critical Digital Capabilities for New Zealand Enterprises" direction="left" />
            </h2>
            <p className="text-slate-600 text-sm sm:text-base font-medium max-w-2xl mx-auto">
              Select or watch the auto-advancing solution pillars below to explore real-time farm-to-port sync and NZ cloud architecture.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
            ...
            <div className="lg:col-span-5 space-y-4">
              {newZealandServicePillars.map((pillar, idx) => {
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <div className="rounded-2xl overflow-hidden border border-slate-200 shadow-md bg-slate-950 relative group">
                    <div className="h-9 bg-slate-900 border-b border-slate-800 px-3.5 flex items-center justify-between">
                      ...
                      <span className="text-[11px] font-mono text-slate-400">
                        nz-solution/{newZealandServicePillars[activePillarIndex].id}
                      </span>
                      <div className="w-8" />
                    </div>
                    ...
                    <div className="relative h-56 sm:h-64">
                      <Image
                        src={newZealandServicePillars[activePillarIndex].image}
                        alt={newZealandServicePillars[activePillarIndex].imageAlt}
                        fill
                      ...
                      <div className="absolute top-3 right-3 px-3 py-1.5 rounded-full bg-slate-950/95 backdrop-blur-md text-[#00D4FF] text-[11px] font-extrabold border border-sky-500/40 shadow-xl flex items-center gap-1.5">
                        <LiveRadarPulse color="bg-[#00D4FF]" />
                        <span>{newZealandServicePillars[activePillarIndex].liveStat}</span>
                      </div>
                    </div>
                    ...
                    <div className="px-4 py-2.5 bg-slate-50 border-t border-slate-200 flex flex-wrap items-center gap-2">
                      ...
                      {newZealandServicePillars[activePillarIndex].techStack.map((t, tIdx) => (
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                    {newZealandServicePillars[activePillarIndex].services.map((srv, sIdx) => (
                      <div
                        key={sIdx}
                  ...
                  <div className="pt-4 border-t border-slate-100 flex items-center justify-between">
                    <span className="text-xs font-bold text-slate-500">100% Kiwi IP &amp; Code Ownership</span>
                    <Link
                      href="/contact"
                      data-modal="quote"
                    ...
                    >
                      <span>Get Kiwi Architecture</span>
      ...
      {/* =========================================================================
          4. HORIZONTAL RUNNING CARDS TRACK (10 Kiwi Industries)
          ========================================================================= */}
      <section className="py-24 lg:py-28 bg-white border-b border-slate-100 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12 text-center space-y-3">
          <div className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-blue-50 text-[#305EFF] text-xs font-extrabold uppercase tracking-wider border border-blue-200">
            ...
            <span>Dynamic Kiwi Industry Ecosystem</span>
          </div>
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-slate-900 tracking-tight">
            <ScrollHeading3D text="Specialized Technology Built for Key New Zealand Sectors" direction="right" />
          </h2>
          <p className="text-slate-600 text-sm sm:text-base font-medium max-w-2xl mx-auto">
            Hover over any industry card to inspect localized workflows, NZ Privacy compliance, and ERP features.
          </p>
        </div>
        ...
        <div className="relative w-full overflow-hidden py-4">
          ...
          >
            ...
            {[...newZealandIndustries, ...newZealandIndustries].map((ind, idx) => {
      ...
      <section className="py-24 lg:py-28 bg-slate-50/90 border-b border-slate-200 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-3">
            ...
            <p className="text-slate-600 text-sm sm:text-base font-medium max-w-2xl mx-auto">
              Replace outdated spreadsheets and disjointed tools with a unified New Zealand enterprise technology platform.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch max-w-5xl mx-auto">
            ...
            <div className="bg-white border-2 border-rose-200 rounded-3xl p-8 flex flex-col justify-between shadow-md">
              <div className="space-y-5">
                ...
                <div className="space-y-3">
                  {[
                    "Unsynchronized spreadsheets causing costly AgriTech and order errors",
                    "Manual follow-ups resulting in lost client opportunities across North & South Islands",
              ...
              <div className="pt-5 mt-5 border-t border-rose-100 text-xs text-rose-600 font-bold">
                Result: Severe operational friction, privacy compliance risks &amp; wasted developer hours.
              </div>
            </div>
            ...
            <div className="bg-white border-2 border-[#305EFF] rounded-3xl p-8 flex flex-col justify-between shadow-2xl relative">
              <div className="space-y-5">
                <div className="flex items-center justify-between border-b border-blue-100 pb-4">
                  <div>
                    <span className="text-xs font-mono uppercase tracking-widest text-[#305EFF] font-bold">After Mitsafe New Zealand</span>
                ...
                <div className="space-y-3">
                  {[
                    ...
                    "Automated NZ GST 15% calculation and IRD-ready export filing logs",
                    "Real-time visibility across Auckland, Wellington, Christchurch and regional branches",
                    "NZ Privacy Act 2020 compliant cloud architecture with automated daily backups",
      ...
      {/* =========================================================================
          6. NZ GST 15% & FINANCIAL SOFTWARE (Dashboard Showcase + 3D Scroll Words)
          ========================================================================= */}
      <section className="py-24 lg:py-28 bg-white border-b border-slate-100 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-14 items-center">
            ...
            {/* Left Column: NZ GST & Financial Content */}
            <div className="lg:col-span-6 space-y-6 text-left">
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-blue-50 text-[#305EFF] text-xs font-extrabold uppercase tracking-wider border border-blue-200">
                <DollarSign className="w-3.5 h-3.5 text-[#305EFF]" />
                <span>NZ GST 15% &amp; FINANCIAL OPERATIONS</span>
              </div>

              <h2 className="text-2xl sm:text-4xl lg:text-[2.6rem] font-black text-slate-900 tracking-tight leading-[1.15]">
                <ScrollHeading3D text="Financial Visibility with IRD Compliance Alignment" direction="left" />
              </h2>

              <p className="text-slate-600 text-sm sm:text-base leading-relaxed">
                Empower your New Zealand enterprise with live financial tracking, automated quote-to-invoice workflows, multi-entity ledgers, and digital record compliance compatible with IRD tax standards.
              </p>

              {/* Vertical Features */}
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5 pt-1">
                {[
                  { title: "NZD Invoicing & Billing", desc: "Automated billing, quote creation, and instant Windcave / Stripe payment links." },
                  { title: "Multi-Entity Ledgers", desc: "Consolidated group reporting across New Zealand branches and global operations." },
                  { title: "Live Stock & Margins", desc: "Accurate transaction tracking with real-time gross margin insights." },
                  { title: "NZ GST 15% Ready", desc: "Digital VAT/GST records and structured data exports for quarterly IRD filing." },
                ].map((feat, idx) => (
              ...
              <TiltCard3D tiltAmount={10} className="w-full max-w-[540px]">
                <div className="rounded-3xl overflow-hidden border-2 border-slate-800 shadow-2xl bg-slate-950 group">
                  <div className="h-9 bg-slate-900 border-b border-slate-800 px-4 flex items-center justify-between">
                    ...
                    <span className="text-[10px] font-mono text-slate-400">
                      nz-fintrack.mitsafe.co.nz // ird-gst-reconciliation
                    </span>
                    <LiveRadarPulse color="bg-emerald-400" />
                  </div>
                  ...
                  <div className="relative">
                    <Image
                      ...
                      alt="New Zealand Business Operations and Financial Management Dashboard"
                      width={640}
                      height={420}
                    ...
                    <Floating3DObject duration={3.8} yOffset={7} rotateRange={2} className="absolute top-4 right-4 z-20">
                      <div className="bg-slate-900/95 backdrop-blur-md px-3.5 py-1.5 rounded-xl border border-sky-500/40 text-[#00D4FF] text-xs font-black shadow-2xl flex items-center gap-2">
                        <LiveRadarPulse color="bg-[#00D4FF]" />
                        <span>NZD Financial Engine</span>
                      </div>
                    </Floating3DObject>
                  </div>
                  ...
                  <div className="p-4 bg-slate-900 text-white text-center border-t border-slate-800 flex items-center justify-between px-6">
                    <div className="text-xs sm:text-sm font-extrabold text-[#00D4FF]">
                      NZ Multi-Branch &amp; Financial Operations Engine
                    </div>
                    <span className="text-[11px] font-mono text-emerald-400 font-bold">
                      GST 15% Compliant (100%)
                    </span>
                  </div>
                </div>
              </TiltCard3D>
      ...
      <section className="py-24 lg:py-28 bg-slate-50/80 border-b border-slate-200 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto mb-14 space-y-3">
            ...
            <p className="text-slate-600 text-sm sm:text-base font-medium max-w-2xl mx-auto">
              Choose the commercial engagement model that matches your Kiwi business capital and operational strategy.
            </p>
                ...
                {deliveryModelTab === "custom" ? (
                  <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
                    <div className="md:col-span-7 space-y-4">
                      ...
                      <p className="text-slate-600 text-xs sm:text-sm leading-relaxed">
                        For Kiwi enterprises that require tailored proprietary software built around their competitive advantage, with 100% IP transferred to your company.
                      </p>
                      <ul className="space-y-3 pt-2 text-xs sm:text-sm font-semibold text-slate-700">
                        ...
                        <li className="flex items-center gap-2.5">
                          <CheckCircle2 className="w-4 h-4 text-[#305EFF]" />
                          <span>Enterprise-grade security and NZ Privacy Act 2020 compliant infrastructure</span>
                        </li>
                      </ul>
                    </div>
                    ...
                    <div className="md:col-span-5 bg-slate-50 p-6 rounded-2xl border border-slate-200 text-center space-y-4">
                      ...
                      <p className="text-xs text-slate-500">Transparent phase-based pricing with defined deliverables and SLA commitments in NZD.</p>
                      <Link
                        href="/contact"
                        data-modal="quote"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
                    <div className="md:col-span-7 space-y-4">
                      ...
                      <p className="text-slate-600 text-xs sm:text-sm leading-relaxed">
                        For New Zealand organizations looking for a dependable digital platform with secure Australasian cloud hosting, proactive maintenance, and dedicated technical support.
                      </p>
                      <ul className="space-y-3 pt-2 text-xs sm:text-sm font-semibold text-slate-700">
                        <li className="flex items-center gap-2.5">
                        ...
                        <li className="flex items-center gap-2.5">
                          <CheckCircle2 className="w-4 h-4 text-emerald-600" />
                          <span>Hosted in Australasian datacentres with continuous monitoring and daily backups</span>
                        </li>
                        <li className="flex items-center gap-2.5">
                          <CheckCircle2 className="w-4 h-4 text-emerald-600" />
                          <span>Direct NZST engineering support, routine security audits &amp; feature updates</span>
                        </li>
                      </ul>
                    </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="max-w-3xl mx-auto relative pl-6 sm:pl-10 space-y-8 before:absolute before:left-3 sm:before:left-5 before:top-4 before:bottom-4 before:w-0.5 before:bg-gradient-to-b before:from-[#305EFF] before:via-[#00D4FF] before:to-blue-200">
            {[
              {
                step: "01",
                title: "Discovery & Kiwi Workflow Analysis",
              ...
              },
              {
                ...
                desc: "Define the right tech stack, database schemas, Windcave payment integrations, and phased milestone roadmap.",
                milestone: "Technical Architecture Plan",
              },
              {
                step: "03",
                title: "UI/UX & Interactive Prototyping",
                desc: "Design intuitive user interfaces that your operations team and Kiwi customers find fast and frictionless to use.",
                milestone: "Figma Prototypes & User Testing",
              },
              {
                step: "04",
                title: "Agile Development & Testing",
                desc: "Develop scalable code, integrate NZ banking APIs, and execute rigorous unit and security tests.",
                milestone: "Production Release & Handover",
              },
              {
                step: "05",
                title: "Support & Ongoing Scaling",
                desc: "Monitor live operations, onboard staff, and continuously scale platform features with dedicated NZST SLA support.",
      ...
      {/* =========================================================================
          9. NEW ZEALAND REGIONAL COVERAGE (Key Cities Footprint Selector)
          ========================================================================= */}
      <section className="py-24 lg:py-28 bg-slate-50/70 border-b border-slate-200 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto mb-14 space-y-3">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-slate-900 tracking-tight">
              <ScrollHeading3D text="Supporting Organizations Across New Zealand" direction="right" />
            </h2>
            <p className="text-slate-600 text-sm sm:text-base font-medium max-w-2xl mx-auto">
              Mitsafe delivers custom software and managed cloud technology for enterprises operating in major Kiwi tech clusters.
            </p>

            {/* Horizontal Cities Pill Bar */}
            <div className="flex flex-wrap items-center justify-center gap-2 pt-6">
              {newZealandCities.map((city, idx) => (
                <button
                  key={idx}
              ...
              >
                <div className="space-y-2 text-left">
                  <div className="flex items-center gap-2.5">
                    ...
                    <h3 className="text-xl sm:text-2xl font-black text-slate-900">
                      {newZealandCities[activeCityIndex].name} Operations
                    </h3>
                    <span className="px-2.5 py-0.5 rounded-full bg-blue-50 text-[#305EFF] text-xs font-bold border border-blue-100">
                      {newZealandCities[activeCityIndex].badge}
                    </span>
                  </div>
                  <p className="text-xs sm:text-sm text-slate-600">
                    <span className="font-bold text-slate-900">Key Business Zones:</span> {newZealandCities[activeCityIndex].hub}
                  </p>
                </div>
                ...
                <div className="shrink-0 text-center sm:text-right">
                  ...
                  <div className="text-lg sm:text-2xl font-black text-[#305EFF]">
                    {newZealandCities[activeCityIndex].projects}
                  </div>
                </div>
              </motion.div>
            </AnimatePresence>
      ...
      {/* =========================================================================
          10. NEW ZEALAND BUSINESS OPERATIONAL FAQ (Interactive Vertical Accordion)
          ========================================================================= */}
      <section className="py-24 lg:py-28 bg-white border-b border-slate-100 relative overflow-hidden">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center mb-16 space-y-3">
            <div className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-blue-50 text-[#305EFF] text-xs font-extrabold uppercase tracking-wider border border-blue-200">
              ...
              <span>Common Kiwi Inquiries</span>
            </div>
            <h2 className="text-3xl sm:text-4xl font-black text-slate-900 tracking-tight">
              <ScrollHeading3D text="Frequently Asked Questions by New Zealand Businesses" direction="left" />
            </h2>
          </div>

          <div className="space-y-3.5">
            {newZealandFaqs.map((faq, fIdx) => {
      ...
      {/* =========================================================================
          11. FINAL NEW ZEALAND CTA SECTION (Solid Dark Navy Background, Clean White Text)
          ========================================================================= */}
      <section className="py-24 lg:py-32 bg-[#030712] text-white relative overflow-hidden border-t border-slate-800">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-8">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-slate-900 border border-sky-500/40 text-[#00D4FF] text-xs font-extrabold uppercase tracking-wider shadow-lg">
            <span>🇳🇿 Let&apos;s Build in New Zealand</span>
          </div>

          <h2 className="text-3xl sm:text-5xl lg:text-6xl font-black text-white tracking-tight leading-tight">
            Have a Kiwi Business Challenge? <br />
          ...
          <p className="text-sm sm:text-lg max-w-2xl mx-auto leading-relaxed text-slate-300">
            Tell us what is slowing your business down — manual processes, AgriTech supply bottlenecks, off-the-shelf software limitations, or a digital product you want to engineer. We&apos;ll help you map out the right technology approach.
          </p>
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 pt-4">
            ...
            >
              <span>Book a Free NZ Consultation</span>
              <ArrowRight className="w-4 h-4 group-hover:translate-x-1.5 transition-transform" />
            </Link>
            ...
            >
              <span>Talk to Our NZ Architects</span>
            </Link>
          </div>
        </div>
      </section>
