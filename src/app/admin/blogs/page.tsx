                        ...
                        <div className="relative w-14 h-11 rounded-xl overflow-hidden border border-slate-200 bg-slate-100 shrink-0 shadow-2xs group-hover/item:border-[#305EFF] transition-colors">
                          <Image
                            ...
                            onError={(e) => {
                              ...
                              if (target && target.src !== "https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?w=1200&auto=format&fit=crop&q=80") {
                                target.src = "https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?w=1200&auto=format&fit=crop&q=80";
                              }
                            }}
                          />
                        </div>
