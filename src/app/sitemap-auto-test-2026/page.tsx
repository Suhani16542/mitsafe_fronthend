...
export const metadata: Metadata = {
  title: "Sitemap Auto Test Page",
  description: "Temporary page to test sitemap automatic inclusion.",
};

export default function SitemapAutoTestPage() {
  return (
