  ...
  return (
    <div className="cosmic-servicedetail-wrapper min-h-screen pt-32 pb-20 relative overflow-hidden text-[#0F172A] dark:text-white transition-colors duration-300">
      ...
      <div className="absolute inset-y-0 inset-x-0 flex justify-between pointer-events-none z-0 px-6 lg:px-8 max-w-7xl mx-auto opacity-[0.05]">
        <div className="w-[1px] bg-[#305EFF]/25 dark:bg-[#00D4FF]/10 h-full" />
        <div className="w-[1px] bg-[#305EFF]/25 dark:bg-[#00D4FF]/10 h-full hidden sm:block" />
        <div className="w-[1px] bg-[#305EFF]/25 dark:bg-[#00D4FF]/10 h-full" />
        <div className="w-[1px] bg-[#305EFF]/25 dark:bg-[#00D4FF]/10 h-full hidden sm:block" />
        <div className="w-[1px] bg-[#305EFF]/25 dark:bg-[#00D4FF]/10 h-full" />
      </div>
      ...
      <div className="absolute w-[450px] h-[450px] rounded-full bg-[#305EFF]/10 dark:bg-[#00D4FF]/5 blur-[120px] pointer-events-none -top-24 -right-12 z-0" />
      <div className="absolute w-[350px] h-[350px] rounded-full bg-[#00D4FF]/10 dark:bg-[#305EFF]/5 blur-[140px] pointer-events-none bottom-24 -left-12 z-0" />

      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        
        {/* Breadcrumb */}
        <div className="flex items-center gap-2 text-xs font-semibold text-slate-400 mb-8 uppercase tracking-wider">
          <Link href="/" className="hover:text-[#305EFF] dark:hover:text-[#00D4FF] transition-colors">Home</Link>
          <span>/</span>
          <span className="text-[#305EFF] dark:text-[#00D4FF]">Expertise</span>
          <span>/</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center mb-28">
          <div className="lg:col-span-6 flex flex-col gap-6 text-left">
            <motion.div
              ...
              className="inline-flex items-center gap-2 rounded-full border border-[#305EFF]/10 dark:border-[#00D4FF]/20 bg-[#305EFF]/5 dark:bg-[#00D4FF]/10 px-4.5 py-1 text-xs font-bold uppercase tracking-wider text-[#305EFF] dark:text-[#00D4FF] shadow-sm w-fit font-mono"
            >
            ...
            <div className="flex flex-col gap-2">
              ...
              >
                Enterprise <span className="text-[#305EFF] dark:text-[#00D4FF]">{role.title}</span>
              </motion.h1>
            ...
            >
              {role.benefits.slice(0, 3).map((benefit, idx) => (
                <div key={idx} className="flex items-center gap-3.5 text-sm text-slate-600 dark:text-slate-300">
                  <div className="w-5 h-5 rounded-full bg-[#305EFF]/5 dark:bg-[#00D4FF]/10 border border-[#305EFF]/15 dark:border-[#00D4FF]/25 text-[#305EFF] dark:text-[#00D4FF] flex items-center justify-center shrink-0">
            ...
            <motion.div
              ...
              className="grid grid-cols-3 gap-6 pt-6 border-t border-[#305EFF]/10 dark:border-white/10 mt-4"
            >
              {role.stats.map((stat, idx) => (
                <div key={idx} className="flex flex-col gap-1.5 group cursor-pointer">
                  <span className="text-2xl md:text-3xl font-extrabold text-[#305EFF] dark:text-[#00D4FF] font-display transition-transform group-hover:scale-105 inline-block">
                    {stat.value}
                  </span>
          ...
          <div className="lg:col-span-6 flex flex-col justify-center relative">
            <motion.div
              ...
              className="relative w-full aspect-[4/3] max-w-[500px] mx-auto rounded-[32px] overflow-hidden border border-[#305EFF]/15 dark:border-white/10 shadow-sm bg-white dark:bg-[#0B1A2E]/70 p-4 group"
            >
              <Image 
                src={assets.image} 
                      ...
                      <div 
                        ...
                        className={`p-2 rounded-xl max-w-[85%] ${
                          msg.sender === "client" 
                            ...
                            : "bg-[#305EFF]/5 dark:bg-[#00D4FF]/10 text-[#305EFF] dark:text-[#00D4FF] border border-[#305EFF]/10 dark:border-[#00D4FF]/20"
                        }`}
                      >
                        {msg.text}
                      </div>
              ...
              {role.slug === "mobile-expert" && (
                ...
                >
                  <div className="w-8 h-8 rounded-full bg-purple-500/10 flex items-center justify-center text-[#305EFF]">
                  ...
                  <div className="h-6 w-full flex items-end justify-between gap-1 px-2">
                    {[3, 6, 8, 4, 9, 7, 9].map((h, i) => (
                      <div key={i} className="bg-[#305EFF] dark:bg-[#00D4FF] rounded-sm w-[4px]" style={{ height: `${h * 10}%` }} />
                    ))}
                  </div>
                </motion.div>
              )}
              ...
              {role.slug === "ui-ux-designer" && (
                ...
                >
                  <div className="flex items-center gap-1.5 text-xs font-bold text-slate-800 dark:text-white border-b border-slate-100 dark:border-white/5 pb-2">
                    <Palette className="w-3.5 h-3.5 text-[#305EFF]" />
                    <span>Figma Components</span>
                  </div>
                  <div className="flex flex-col gap-1.5">
                    <div className="flex justify-between items-center bg-[#305EFF]/5 dark:bg-[#00D4FF]/10 p-1.5 rounded-lg border border-[#305EFF]/10 dark:border-[#00D4FF]/20">
                      <span className="text-[9px] font-bold text-[#305EFF] dark:text-[#00D4FF]">Primary Button</span>
                      <div className="w-3 h-3 bg-[#305EFF] dark:bg-[#00D4FF] rounded-sm" />
                    </div>
        ...
        <section className="mb-28">
          <div className="text-center mb-16 max-w-2xl mx-auto flex flex-col gap-3">
            <span className="text-[10px] font-bold text-[#305EFF] dark:text-[#00D4FF] tracking-widest uppercase font-mono">
              EXPERT SERVICES
            </span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {role.responsibilities.map((serviceName, idx) => (
              <motion.div
                ...
                className="bg-white/70 dark:bg-[#0B1A2E]/70 border border-slate-200 dark:border-white/10 rounded-[24px] p-6.5 shadow-sm hover:shadow-md hover:border-[#305EFF]/30 dark:hover:border-white/20 transition-all duration-300 relative group overflow-hidden backdrop-blur-xl flex flex-col justify-between text-left"
              >
                <div className="absolute top-0 right-0 w-24 h-24 bg-[#305EFF]/5 dark:bg-white/5 rounded-bl-[100px] pointer-events-none transition-all group-hover:bg-[#305EFF]/10" />
                
                <div className="flex flex-col gap-4">
                  <div className="w-11 h-11 rounded-xl bg-[#305EFF]/5 dark:bg-[#00D4FF]/10 border border-[#305EFF]/10 dark:border-[#00D4FF]/20 flex items-center justify-center text-[#305EFF] dark:text-[#00D4FF] group-hover:bg-[#305EFF]/10 dark:group-hover:bg-[#00D4FF] dark:group-hover:text-[#071426] transition-all duration-300 shadow-sm shrink-0">
                ...
                <div className="flex items-center gap-1 text-xs font-bold text-[#305EFF] dark:text-[#00D4FF] mt-6.5 opacity-80 group-hover:opacity-100 transition-opacity">
        ...
        <section className="mb-28 pt-16 border-t border-slate-200 dark:border-white/10 text-left">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-5 flex flex-col gap-6">
              ...
              <div className="flex items-center gap-4 bg-[#305EFF]/5 dark:bg-[#00D4FF]/10 border border-[#305EFF]/10 dark:border-[#00D4FF]/20 rounded-2xl p-4">
                <ShieldCheck className="w-8 h-8 text-[#305EFF] dark:text-[#00D4FF] shrink-0" />
            ...
            <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-6">
              {role.features.map((feature, idx) => (
                <motion.div
                  whileHover={{ y: -4 }}
                  key={idx}
                  className="bg-white/80 dark:bg-[#0B1A2E]/80 border border-slate-200 dark:border-white/10 rounded-[24px] p-6 shadow-sm flex flex-col gap-2.5 hover:border-[#305EFF]/30 dark:hover:border-white/20 transition-all duration-300 text-left"
                >
                  <div className="w-9 h-9 rounded-lg bg-[#305EFF]/5 dark:bg-[#00D4FF]/10 border border-[#305EFF]/10 dark:border-[#00D4FF]/20 flex items-center justify-center text-[#305EFF] dark:text-[#00D4FF]">
              ...
              <div className="bg-gradient-to-br from-[#305EFF] via-[#0052D4] to-[#0B1A2E] rounded-[24px] p-6 text-white flex flex-col justify-between min-h-[160px] shadow-sm border border-[#305EFF]/15 dark:border-white/10 text-left">
        ...
        <section className="mb-28 py-16 bg-[#305EFF]/5 dark:bg-[#0B1A2E]/50 border border-[#305EFF]/10 dark:border-white/10 rounded-[32px] p-8 md:p-12 relative overflow-hidden text-left">
          <div className="absolute w-44 h-44 rounded-full bg-[#305EFF]/10 dark:bg-[#305EFF]/5 blur-3xl -top-10 -left-10 pointer-events-none" />
            ...
            <div className="lg:col-span-8 flex flex-wrap gap-3">
              {role.skills.map((tech, idx) => (
                <motion.span
                  ...
                  key={idx}
                  className="text-xs font-bold px-5 py-3.5 rounded-2xl border border-slate-200 dark:border-white/10 bg-white dark:bg-[#071426]/60 text-[#305EFF] dark:text-[#00D4FF] shadow-sm uppercase tracking-wider cursor-pointer transition-colors hover:border-[#305EFF]/30 dark:hover:border-[#00D4FF] hover:text-[#305EFF] dark:hover:text-white font-mono"
                >
                  {tech}
                </motion.span>
              ))}
        ...
        <section className="relative rounded-[36px] overflow-hidden bg-gradient-to-br from-[#071426] to-[#0B1A2E] border border-[#305EFF]/15 dark:border-white/10 p-8 md:p-16 text-center text-white shadow-lg flex flex-col items-center justify-center gap-6">
