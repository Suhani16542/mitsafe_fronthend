...
const homeServices = [
  ...
  },
  {
    ...
    showcase: [
      "/showcase/hosting_1.webp",
      "/showcase/hosting_2.webp",
      "/showcase/hosting_3.webp",
    ],
  ...
  },
  {
    ...
    showcase: [
      "/showcase/social_1.webp",
      "/showcase/social_media_middle.webp",
      "/video-editing-mockup.webp",
    ],
    slug: "/services/digital-marketing",
  },
  {
    ...
    showcase: [
      "/hero-software-dev.webp",
      "/solutions_engineering.webp",
      "/about_company.webp",
    ],
  ...
  },
  {
    ...
    showcase: [
      "/portfolio_apex_crypto.webp",
      "/portfolio_core_erp.webp",
      "/hero-api.webp",
    ],
    slug: "/services/cloud-devops",
  },
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-left mb-6">
          {/* Badge */}
          <div className="mb-2 inline-flex items-center gap-2 rounded-full border border-[#305EFF]/40 bg-[#305EFF]/5 px-3 py-0.5 text-[11px] font-bold uppercase tracking-wider text-[#305EFF] font-display shadow-xs">
            OUR SERVICES
          </div>
          {/* Title */}
          <h2
              ...
              >
                ...
                <div className="grid grid-cols-12 gap-6 lg:gap-8 items-center relative z-10">
                  ...
                  <div className="col-span-12 md:col-span-5 lg:col-span-4 flex flex-col items-start gap-4">
                    ...
                    <Link
                      href={service.slug}
                      className={`inline-flex items-center gap-1.5 text-xs font-bold uppercase tracking-wider transition-all duration-300 group/link ${isHovered ? "text-white" : "text-[#305EFF]"
                        }`}
                    >
                      <span>Explore Service</span>
                      <ArrowUpRight
                        className={`w-4 h-4 transition-transform duration-300 group-hover/link:translate-x-1 group-hover/link:-translate-y-1 ${isHovered ? "text-white" : "text-black"
                          }`}
                      />
                    </Link>
                  </div>
