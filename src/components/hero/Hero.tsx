  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="absolute left-1 sm:left-3 top-[38%] sm:top-1/2 -translate-y-1/2 z-30 flex h-10 w-10 sm:h-12 sm:w-12 items-center justify-center rounded-full border border-slate-200/90 bg-white/95 text-slate-700 shadow-lg backdrop-blur-md transition-all hover:bg-[#0052FF] hover:text-white hover:border-[#0052FF] hover:scale-110 active:scale-95 cursor-pointer"
      >
      ...
      <button
        ...
        className="absolute right-1 sm:right-3 top-[38%] sm:top-1/2 -translate-y-1/2 z-30 flex h-10 w-10 sm:h-12 sm:w-12 items-center justify-center rounded-full border border-slate-200/90 bg-white/95 text-slate-700 shadow-lg backdrop-blur-md transition-all hover:bg-[#0052FF] hover:text-white hover:border-[#0052FF] hover:scale-110 active:scale-95 cursor-pointer"
      >
        <ChevronRight className="h-5 w-5 sm:h-6 sm:w-6" />
      </button>

      <div className="relative mx-auto w-[95%] max-w-[1360px] px-3 sm:px-5 lg:px-6 pb-4 sm:pb-6 pt-28 sm:pt-30 lg:pt-[122px]">
        ...
        <div className="w-full max-w-6xl mx-auto mt-4 sm:mt-5">
