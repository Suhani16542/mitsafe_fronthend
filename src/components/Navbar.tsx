  ...
  return (
    <>
      ...
      <div className="fixed top-0 left-0 w-full z-50">
        ...
        {/* 1. Premium Modern IT/SaaS Top Announcement Bar (Subtle SaaS Motion & Micro-Interactions) */}
        <div className="w-full h-[54px] md:h-[58px] bg-gradient-to-r from-[#F8FBFF] via-[#F0F7FF] to-[#EAF4FF] animate-topbar-gradient border-b border-slate-200/90 backdrop-blur-md px-3 sm:px-6 lg:px-8 flex items-center justify-between pointer-events-auto gap-2 sm:gap-3 shadow-[0_2px_15px_rgba(0,0,0,0.05)] relative z-20 overflow-hidden font-sans">

          {/* Top SaaS Blue Accent Line */}
          <div className="absolute top-0 left-0 right-0 h-[2.5px] bg-gradient-to-r from-blue-600 via-indigo-600 to-blue-600 animate-topbar-gradient" />

          {/* Left Side: Email & Phone (Smooth hover lifts & icon glows) */}
          <div className="flex items-center gap-2 sm:gap-3 tracking-wide shrink-0 z-20">
            {/* 1. Email Icon + Email Address */}
            <a
              href="mailto:moderntechnologies12@gmail.com"
              className="flex items-center gap-2 transition-all duration-300 hover:-translate-y-0.5 group shrink-0"
            >
              <div className="w-7.5 h-7.5 rounded-full bg-gradient-to-tr from-blue-600 to-indigo-600 flex items-center justify-center group-hover:scale-105 group-hover:shadow-[0_0_12px_rgba(37,99,235,0.45)] transition-all duration-300 shrink-0 shadow-xs top-bar-white-icon">
                <Mail className="w-4 h-4 text-white" />
              </div>
              <span className="text-[14px] sm:text-[15px] font-extrabold tracking-tight hidden sm:inline top-bar-black-item group-hover:text-blue-600 transition-colors duration-300">
                moderntechnologies12@gmail.com
              </span>
            </a>

            {/* Vertical Separator */}
            <div className="h-4 w-[1px] bg-blue-200 hidden xs:block" />
            ...
            >
              ...
              <span className="text-[14px] sm:text-[15px] font-extrabold tracking-tight hidden md:inline top-bar-black-item group-hover:text-blue-600 transition-colors duration-300">
                +91 6265944392
              </span>
            </a>
          </div>

          {/* 3. Fast Vertical USP Slider (Subtle Float & Glass Reflection Sweep) */}
          <div
            className="flex-1 min-w-0 max-w-[340px] md:max-w-[420px] h-full relative flex items-center justify-center overflow-hidden z-10 mx-1 sm:mx-2 cursor-pointer animate-pill-float"
            onMouseEnter={() => setTopBarHovered(true)}
            onMouseLeave={() => setTopBarHovered(false)}
          >
            {/* Top & Bottom Mask Fades */}
            <div className="absolute left-0 right-0 top-0 h-3 bg-gradient-to-b from-[#F8FBFF] to-transparent z-20 pointer-events-none" />
            <div className="absolute left-0 right-0 bottom-0 h-3 bg-gradient-to-t from-[#EAF4FF] to-transparent z-20 pointer-events-none" />
            ...
            <AnimatePresence mode="popLayout" initial={false}>
              ...
              >
                <div className="relative flex items-center justify-center gap-2.5 sm:gap-3 px-4 py-1.5 rounded-xl bg-white border border-blue-200/80 shadow-[0_3px_12px_rgba(37,99,235,0.08)] hover:bg-slate-50 hover:border-blue-300 hover:shadow-[0_4px_18px_rgba(37,99,235,0.15)] hover:scale-[1.01] transition-all duration-300 group/pill shrink-0 max-w-full overflow-hidden">
                  {/* Soft Occasional Glass Reflection Sweep */}
                  <div className="absolute inset-0 w-16 h-full bg-gradient-to-r from-transparent via-blue-200/40 to-transparent pointer-events-none animate-slider-shine" />

                  <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-blue-600 to-indigo-600 flex items-center justify-center shrink-0 shadow-xs top-bar-white-icon group-hover/pill:shadow-[0_0_12px_rgba(37,99,235,0.5)] transition-all duration-300">
                    {React.createElement(announcementItems[announcementIndex].icon, { className: "w-[20px] h-[20px] text-white" })}
                  </div>
                  <span className="font-extrabold text-[14.5px] sm:text-[15px] tracking-tight whitespace-nowrap truncate top-bar-black-item relative z-10">
                    {announcementItems[announcementIndex].text}
                  </span>
                </div>
              </motion.div>
            </AnimatePresence>
          ...
          {/* Right Side: 4. Brand Message + 5. Social Icons */}
          <div className="flex items-center gap-2 sm:gap-3 shrink-0 z-20">
            {/* 4. Short Brand Message */}
            <span className="text-[14px] sm:text-[15px] font-extrabold tracking-tight whitespace-nowrap hidden 2xl:inline top-bar-black-item">
              Innovative Digital Solutions for Every Business.
            </span>

            {/* Vertical Separator */}
            <div className="h-4 w-[1px] bg-blue-200 hidden 2xl:block" />

            {/* 5. Social Media Icons (1.08–1.1x Hover Scale + Soft Blue Glow) */}
        ...
        {/* 2. Floating Navbar directly below Top Bar (Seamless Light Blue/White Theme matching Top Bar) */}
        <div className="w-full flex justify-center pt-2.5 pointer-events-auto">
          <header className="w-[95%] max-w-[1360px] transition-all duration-300 border border-[#D6E9FF] rounded-2xl sm:rounded-3xl backdrop-blur-2xl bg-gradient-to-r from-[#F8FBFF]/95 via-[#F0F7FF]/95 to-[#EAF4FF]/95 shadow-[0_12px_40px_rgba(37,99,255,0.08)] h-[68px] flex items-center">
              ...
              <div className="flex items-center gap-[20px] h-full">
                ...
                <Link href="/" className="flex items-center group shrink-0">
                  <Image
                    ...
                    width={130}
                    height={86}
                    className="h-auto w-[112px] sm:w-[126px] md:w-[136px] filter drop-shadow-[0_0_8px_rgba(0,229,255,0.2)] brightness-105 transition-transform duration-300 hover:scale-105"
                    priority
                  />
                </Link>
